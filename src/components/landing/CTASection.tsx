        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <Button size="xl" variant="outline" className="border-white/30 bg-white/5 text-white hover:bg-white/10 rounded-2xl font-bold px-10 backdrop-blur-sm" asChild>
              <a href="https://wa.me/5583996583281?text=Ol%C3%A1!%20Gostaria%20de%20falar%20com%20um%20consultor%20do%20Pulse%20Doa%C3%A7%C3%B5es." target="_blank" rel="noopener noreferrer">
                Falar com Consultor
              </a>
            </Button>
          </div>
